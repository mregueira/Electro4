...
with open('2cvi15.txt', 'r') as csvfile: #aca cargo los datos de una curva en x e y
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        x1.append(float(row[0]))
        y1.append(float(row[2]))

with open('2cvi21.txt', 'r') as csvfile:  # aca empieza otra curva
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
...
with open('2cvi27.txt', 'r') as csvfile:#aca empieza otra curva
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
