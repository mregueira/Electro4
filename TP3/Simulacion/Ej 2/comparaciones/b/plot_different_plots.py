...
axs[0].plot(x1, y1, label='ma=0.8', color='cyan', linewidth=1.3)
#axs[0].set_title('Tensión para diferentes valores de R')
axs[0].set_title('Comparación de tensiones con mf=15')
axs[0].set_xlim([0,0.025])
axs[0].legend()
#axs[0].set_yticks(np.arange(-0.9, 1.0, 0.4))
#axs[0].set_ylim(-1, 1)

axs[1].plot(x2, y2, label='ma=1', color='magenta', linewidth=1.3)
axs[1].set_ylabel('V')
axs[1].legend()
#axs[1].set_yticks(np.arange(0.1, 1.0, 0.2))
#axs[1].set_ylim(0, 1)

axs[2].plot(x3, y3, label='ma=1.3', color='darkorange', linewidth=1.3)
