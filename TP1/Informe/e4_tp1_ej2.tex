...
En los c\'alculos que se realizaron en el inciso a) se consider\'o al diodo como ideal. Si tenemos en cuenta la ca\'ida del diodo cuando conduce, la tensi\'on en el inductor mientras $SW=OFF$ es $V_{L}=-V_o-0.7$. Adem\'as, debemos considerar el pico de corriente de reverse recovery cuando el diodo deja de conducir. 



Como la tensi\'on $V_L$ se ve afectada por el comportamiento no ideal del diodo, tambi\'en se ver\'a afectada la $D_{ideal}$ calculada.
...
Considerando el ripple que nos agreg\'o la ESR del capacitor, obtuvimos que la $D$ que cumple con los requerimientos de nuestra fuente es $D_{real}=0.715$.
