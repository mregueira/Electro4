...
\end{equation}
  ...
  \centering
    ...
    \caption{ Singularidades del convertidor Boost}
  \end{figure}
...
A medida que el cero del amplificador de error se acerca al origen, el tiempo de establecimiento aumenta. En el caso de $R_6=22k\Omega$, el sistema resulta inestable. Mientras que en los otros dos casos, el sistema resulta amortiguado. 
